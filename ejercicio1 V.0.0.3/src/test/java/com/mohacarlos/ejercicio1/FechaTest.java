...
public class FechaTest {
     ...
     */
    @Test
    public void testSetDia2() throws ExcepcionFecha {
        int dia = 31;
        Fecha instance = new Fecha(20,2,200);
        try{
            instance.setDia(dia,2);
        }catch(ExcepcionFecha ex){
            assert(true);
        }
    }
    ...
    public void testSetMes1() throws ExcepcionFecha {
        int mes = 10;
        Fecha instance = new Fecha(1,2,200);
        instance.setMes(mes);
    }
     ...
     */
    @Test
    public void testSetMes2() throws ExcepcionFecha {
        int mes = 31;
        Fecha instance = new Fecha(20,4,200);
        try{
            instance.setMes(mes);
        }catch(ExcepcionFecha ex){
            assert(true);
